...
class Constants {
    companion object {
        // Advertisement timeout for legacy mode (ms). 0 = no auto-stop.
        // Lower values cycle faster but may cause missed packets on slow devices.
        const val ADVERTISE_TIMEOUT = 0
