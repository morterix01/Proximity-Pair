...
class ContinuityNewDevicePopUpAdvertisementSetGenerator: IAdvertisementSetGenerator {

    private val _logTag = "ContinuityNewDevicePopUpAdvertisementSetGenerator"
    ...
    override fun getAdvertisementSets(inputData: Map<String, String>?): List<AdvertisementSet> {
        ...
        data.forEach{deviceData ->
            ...
            // General Data
            advertisementSet.title = "New " + deviceData.value
