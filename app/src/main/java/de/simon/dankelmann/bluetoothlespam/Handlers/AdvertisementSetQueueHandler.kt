...
class  AdvertisementSetQueueHandler :IAdvertisementServiceCallback{
    ...
    private val _callbackHandler = Handler(Looper.getMainLooper())
    private var _pendingLocalCallback: Runnable? = null
    ...
    fun advertiseNextAdvertisementSet(){
        ...
        if(_currentAdvertisementSet != null){
            ...
            Log.e(_logTag, "Current Advertisement Set is null. Queue is likely empty.")
        }
    }
    ...
    fun selectNextAdvertisementSet(){
        ...
        when(_advertisementQueueMode){
            ...
            AdvertisementQueueMode.ADVERTISEMENT_QUEUE_MODE_RANDOM -> {
                if(_advertisementSetCollection.advertisementSetLists.isEmpty()){
                    nextAdvertisementSet = null
                } else {
                ...
                val nextAdvertisementSetList = _advertisementSetCollection.advertisementSetLists.get(nextAdvertisementSetListIndex)
                    if(nextAdvertisementSetList.advertisementSets.isEmpty()){
                        nextAdvertisementSet = null
                    } else {
    ...
    private fun clearPendingLocalCallback(){
        _pendingLocalCallback?.let { _callbackHandler.removeCallbacks(it) }
        _pendingLocalCallback = null
    }
